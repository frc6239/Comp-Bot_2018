...
public class RobotMap {
	...
	RobotMap() {
		...
		speedController = new Spark[] { frontRightSpeedControl, frontLeftSpeedControl, backRightSpeedControl,
				backLeftSpeedControl };
		rotationalController = new Spark[] { frontRightRotControl, frontLeftRotControl, backRightRotControl,
				backLeftRotControl };
		...
		encController = new PIDController[] { frontRightController, frontLeftController, backRightController,
				backLeftController };
